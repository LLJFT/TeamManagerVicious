...
export default function TournamentStats() {
  ...
  const tournamentEvents = events.filter(e => e.eventType === "tournament");
            ...
            {statsByGameMode.length === 0 ? (
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">No game mode statistics available for tournaments yet.</p>
                </CardContent>
              </Card>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {statsByGameMode.map(({ mode, ...stats }) => (
                  <Card key={mode.id} className="border-amber-500/20">
                    <CardHeader className="pb-2">
                      <CardTitle className="flex items-center gap-2 text-base">
                        <Gamepad2 className="h-5 w-5 text-primary" />
                        {mode.name}
            ...
            {statsByMap.length === 0 ? (
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">No map statistics available for tournaments yet.</p>
                </CardContent>
              </Card>
            ) : (
