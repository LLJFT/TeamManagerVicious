      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-3xl font-bold text-foreground">Monthly Statistics</h1>
              </div>
              <p className="text-muted-foreground">Performance filtered by month</p>
            </div>
          </div>
        ...
        <Card className="mb-8">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Choose a month to view its statistics</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <CardHeader className="pb-4 border-b border-border">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <CardDescription>Win rate for this month</CardDescription>
                        </div>
                      </div>
                    </CardHeader>
